                                ...
                                {isAuth == false ? (
                                    ...
                                    <nav className={style.navBurgerMenu}>
                                        ...
                                        <nav className={style.navBurgerMenuLinks}>
                                            <Link className={style.LinkBurgerMenu} href="/sendfile">
                                                Отправить
                                            </Link>
                                            <a className={style.LinkBurgerMenu} href="/getfile">
                                                Получить
                                            </a>
                                            <Link className={style.LinkBurgerMenu} href="/story">
                                                История
                                            </Link>
                                        </nav>
                                    </nav>
                                    ...
                                    <div>
                                        <nav className={style.navBurgerMenuLinks}>
                                            ...
                                            <Link className={style.LinkBurgerMenu} href="/signup">
                                                Регистрация
                                            </Link>
                                            <Link className={style.LinkBurgerMenu} href="/login">
                                                Вход
                                            </Link>
