            ...
            <div className={style.blockStory}>
                ...
                <div className={style.formStoryView}>
                    <div className={style.formStoryLinks}>
                        ...
                        <Link
                            className={` ${style.storyLinkStyle} ${style.linkStyleBorderRadiusButton} `}
                            href={'/story/get'}
                        >
                            <div className={style.linkInfoStyle}>
                                <svg
