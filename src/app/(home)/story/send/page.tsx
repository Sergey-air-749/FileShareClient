            ...
            <div className={style.blockStory}>
                ...
                <div className={style.formGetFileStory}>
                    ...
                    <div className={style.formFileStoryView}>
                        ...
                        {/* <div className={style.formFileStoryToolsBlock}> */}

                            <div className={style.formFileStoryShareBlock}>



                            </div>
{/* 
                            <div className={style.formFileStoryFiltersBlock}>

                                <IMaskInput
                                    mask={'00.00.0000'} // Example phone mask
                                    // Use onAccept to handle changes, NOT onChange
                                    onAccept={(value, mask) => {
                                        // value is the unmasked value if unmask={true} (default is false)
                                        console.log(value); 
                                    }}
                                    type="tel"
                                    placeholder="Поиск по дате"
                                    className={style.inputFiltersDate}
                                    // You can add other standard input props like className, id, etc.
                                />

                                <select className={style.selectOptionStyle}>
