                ...
                <div className={style.formGetFileStory}>
                                    ...
                                    <div className={style.filtersStoryPopUpMain}>
                                        ...
                                        <div className={style.filtersStoryPopUpOptions}>
                                            ...
                                            <div className={style.filtersStoryPopUpOptionBlock}>
                                                ...
                                                <input type="date" className={style.inputFiltersDate} value={filters.date} onChange={(e) => dateParser(e)}  name="date"/>    
                    ...
                    <div className={style.formHead}>
                        ...
                        <div className={style.formTitle}>
                            ...
                            <p>Здесь вы можете посмотреть все файлы которые вы отправели, время, кому вы отправель и с какого устройства</p>
                        </div>
                    ...
                    <div className={style.formFileStoryView}>
                        ...
                        <div className={style.formFileStoryHead}>
                            ...
                            <div className={style.formFileStoryButtons}>
                                ...
                                <button type="button" onClick={() => showSettingsPopUpFun()} className={style.formFileStoryFilrets}>
                        ...
                        <div className={style.inputShareBlock}>
                            <input className={style.inputFilters} type="text" placeholder="Поиск по названию" value={filters.search} onChange={(e) => setFilters({ ...filters, search: e.target.value }) }/>
                        </div>
