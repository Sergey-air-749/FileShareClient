...
export default function Getfile() {
            ...
            if (files[i].text != undefined) {
                ...
                try {
                    ...
                    const response = await axios.get(
                        fileApiUrl + `/api/getDownloadNew/file/${userData?.shareId}/${files[i].id}`
                    );
                    //console.log(response.data);
    ...
    const allFilesCancelFun = async () => {
        try {
            ...
            setFiles([]);
            await axios.post(
                fileApiUrl + '/api/files/cancel/' + userData?.shareId,
                {},
                {
                    headers: {
    ...
    const fileCancelFun = async (id: string) => {
        try {
            ...
            const response = await axios.post(
                fileApiUrl + '/api/files/cancel/' + userData?.shareId + '/' + id,
                {},
                {
                    headers: {
                        'Content-Type': 'application/json',
                                                    ...
                                                    {file.filename != undefined ? (
                                                        <div className={style.fileButtons}>
                                                            ...
                                                            <button
                                                                ...
                                                                type="button"
                                                                onClick={() => fileAcceptFun(file.filename, file.id)}
                                                            >
                                                                Скачать
                                                            </button>
                                                        </div>
