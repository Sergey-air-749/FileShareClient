...
// Добавить директорию с страницами доступными без аккаунта (recovering account) ✅

// Из-за того что раньше страница recovering account находилась в /(account)/recovering
// layout в папке /(account)/layout.tsx делал запрос для получения данных пользователя если данные не получены збрасывал на страницу /login
