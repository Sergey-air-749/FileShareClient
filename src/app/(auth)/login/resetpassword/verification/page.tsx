        ...
        <div className={style.resetPasswordVerification}>
            ...
            <form className={style.formResetPasswordVerification} onSubmit={(e) => submitUserUpData(e)}>
                ...
                <div className={style.formInputs}>
                    ...
                    <div className={style.passwordBlock}>
                        <input className={style.inputStylePassword} onChange={(e) => validationInputPasswordRepeat(e)} placeholder="Повторите новый пароль" type={showPasswordRepeatStatus} name="passwordRepeat" id="passwordRepeat" required/>
