...
import { verifyAccountDeleteSessionServer } from './actions';
                    ...
                    <main>
                        <div className={style.deleteAccountSuccessfullyMainHead}>
                            ...
                            <div className={style.formTitle}>
                                <h2>{intl.formatMessage({ id: 'deleteAccountSuccessfully.formTitleH2' })}</h2>
                            </div>
                        </div>

                        <div className={style.deleteAccountSuccessfullyInfo}>
                            <p>{intl.formatMessage({ id: 'deleteAccountSuccessfully.info' })}</p>
                        </div>

                        <div className={style.deleteAccountSuccessfullyLinks}>
                            <Link href="/sendfile" className={style.Link}>
                                {intl.formatMessage({ id: 'deleteAccountSuccessfully.link.home' })}
                            </Link>
                        </div>
                    </main>
                </div>
