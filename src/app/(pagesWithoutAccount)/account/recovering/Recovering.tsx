...
export default function Recovering() {
    ...
    const submitRecoveringUser = async (e: FormEvent<HTMLFormElement>) => {
        e.preventDefault();
        ...
        try {
            ...
            router.push('/account/recovering/successfully');
        } catch (error) {
            closeLoaderFun();
            console.log(error);
    ...
    return (
        <div className={style.recovering}>
            <form className={style.formRecovering} onSubmit={(e) => submitRecoveringUser(e)}>
